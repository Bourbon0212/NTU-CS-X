...
---
## TextMining
Before we start, we should install all packages about TextMining first.
```{r eval = FALSE}
...
## Source
抓取PTT pc_shopping 2938~2943頁.
```{r eval = F}
source('pttTestFunction.R')
id = c(2938:2943)
URL = paste0("https://www.ptt.cc/bbs/PC_Shopping/index", id, ".html")
